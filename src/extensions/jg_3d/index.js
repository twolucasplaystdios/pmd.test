...
class Jg3DBlocks {
    ...
    touching(name1, name2) {
        ...
        const hull1 = new ConvexGeometry().setFromPoints(object1.geometry.attributes.position.array);
        const hull2 = new ConvexGeometry().setFromPoints(object2.geometry.attributes.position.array);
