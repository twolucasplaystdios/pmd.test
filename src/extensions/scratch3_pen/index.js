    ...
    goPenLayer (args) {
        if (this.runtime.renderer) {
            if (args.OPTION === LayerParam.FRONT) {
                ...
                //this.runtime.renderer.setDrawableOrder(this._penDrawableId, 3, StageLayering.PEN_LAYER);
                ...
                //this.runtime.renderer.setDrawableOrder(this._penDrawableId, 2, StageLayering.PEN_LAYER);
            }
        }
    }
